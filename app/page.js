...
export default function Home(){
  ...
  return <main>
    ...
    <section id="top" className="hero light-surface"><div className="shell hero-grid">
      ...
      <div className="hero-art textile-hero" aria-hidden="true"><img className="textile-flow textile-flow-back" src="assets/textile-flow.webp" alt=""/><img className="textile-flow textile-flow-main" src="assets/textile-flow.webp" alt=""/></div>
    </div></section>

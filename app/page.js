...
export default function Home(){
  ...
  return <main>
    ...
    <section id="top" className="hero light-surface"><img className="hero-bg" src="/assets/bg-light.webp" alt="" aria-hidden="true"/><div className="shell hero-grid">
      ...
      <div className="hero-art"><div className="orbit orbit-a"></div><div className="orbit orbit-b"></div><div className="hero-portrait-placeholder"><span>WisConnect</span><strong>Visionary portrait</strong></div></div>
    </div></section>
    ...
    <section id="impact" className="section impact-section dark-surface"><img className="impact-bg" src="/assets/bg-dark.webp" alt="" aria-hidden="true"/><div className="shell impact-inner"><div className="section-heading split-heading light-copy"><div><p className="eyebrow">Impact & proof</p><h2>Evidence before impressive-looking numbers.</h2></div><p>Public metrics should only appear after WisConnect verifies them.</p></div><div className="impact-grid"><div><span>Members</span><strong>—</strong><p>Verified count</p></div><div><span>Member businesses</span><strong>—</strong><p>Verified count</p></div><div><span>Projects & programs</span><strong>—</strong><p>Verified activity</p></div><div><span>Community outcomes</span><strong>—</strong><p>Measured impact</p></div></div></div></section>

    <section className="section global-section"><div className="shell global-grid"><div className="global-copy"><p className="eyebrow">Local roots. Global reach.</p><h2>The orbit becomes the story.</h2><p>WisConnect’s network is rooted in Africa and extends toward relationships and opportunities across regions.</p><div className="region-buttons">{Object.keys(regions).map(r=><button key={r} className={region===r?'active':''} onClick={()=>setRegion(r)}>{r}</button>)}</div><div className="region-detail"><strong>{region}</strong><p>{regions[region]}</p></div></div><div className="global-orbit"><div className="ring ring-1"></div><div className="ring ring-2"></div><div className="ring ring-3"></div><div className="orbit-center"><span>W</span></div><span className="node node-us">US</span><span className="node node-br">BR</span><span className="node node-vn">VN</span><span className="node node-af">AF</span></div></div></section>
